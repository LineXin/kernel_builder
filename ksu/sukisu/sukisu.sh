...
cp security/selinux/selinuxfs.c drivers/kernelsu/security/selinux/selinuxfs.c 2>/dev/null || true
cp security/selinux/selinuxfs.c KernelSU/security/selinux/selinuxfs.c 2>/dev/null || true
